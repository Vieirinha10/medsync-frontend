export const visualChallenges = [
  ...
  {
    id: 'desafio-visual-141',
    category: 'Genética Clínica',
    modality: 'Cariograma',
    difficulty: 'Básico',
    imageSrc: '/images/desafios/desafio-visual-141.webp',
  ...
  {
    id: 'desafio-visual-142',
    category: 'Genética Clínica',
    modality: 'Cariograma',
    difficulty: 'Intermediário',
    imageSrc: '/images/desafios/desafio-visual-142.webp',
  ...
  {
    id: 'desafio-visual-143',
    category: 'Genética Clínica',
    modality: 'Cariograma',
    difficulty: 'Avançado',
    imageSrc: '/images/desafios/desafio-visual-143.webp',
  ...
  {
    id: 'desafio-visual-144',
    category: 'Genética Clínica',
    modality: 'Dermatologia clínica',
    difficulty: 'Intermediário',
    imageSrc: '/images/desafios/desafio-visual-144.webp',
  ...
  {
    id: 'desafio-visual-145',
    category: 'Genética Clínica',
    modality: 'Radiografia de membro superior',
    difficulty: 'Avançado',
    imageSrc: '/images/desafios/desafio-visual-145.webp',
  ...
  {
    id: 'desafio-visual-146',
    category: 'Neonatologia',
    modality: 'Radiografia de tórax',
    difficulty: 'Básico',
    imageSrc: '/images/desafios/desafio-visual-146.webp',
    imageAlt: 'Radiografia neonatal com alças intestinais no hemitórax esquerdo e desvio do mediastino',
    question: 'Recém-nascido apresenta desconforto respiratório grave, abdome escavado e murmúrio vesicular reduzido à esquerda. Qual diagnóstico explica a radiografia?',
    options: [
      { id: 'hernia-diafragmatica-congenita', label: 'Hérnia diafragmática congênita' },
      { id: 'malformacao-vias-aereas', label: 'Malformação congênita das vias aéreas pulmonares' },
      { id: 'pneumotorax-hipertensivo', label: 'Pneumotórax hipertensivo' },
      { id: 'enfisema-lobar-congenito', label: 'Enfisema lobar congênito' },
    ],
  },
  {
    id: 'desafio-visual-147',
    category: 'Neonatologia',
    modality: 'Radiografia de tórax',
    difficulty: 'Básico',
    imageSrc: '/images/desafios/desafio-visual-147.webp',
  ...
  {
    id: 'desafio-visual-148',
    category: 'Neonatologia',
    modality: 'Radiografia de abdome',
    difficulty: 'Intermediário',
    imageSrc: '/images/desafios/desafio-visual-148.webp',
    imageAlt: 'Radiografia abdominal neonatal com gás na parede de alças intestinais e no sistema venoso portal',
    question: 'Prematuro em dieta enteral evolui com distensão abdominal e sangue nas fezes. Qual diagnóstico é indicado pela pneumatose intestinal observada na radiografia?',
    options: [
      { id: 'enterocolite-necrosante', label: 'Enterocolite necrosante' },
      { id: 'ileo-meconial', label: 'Íleo meconial' },
      { id: 'doenca-hirschsprung', label: 'Doença de Hirschsprung' },
      { id: 'perfuracao-intestinal-espontanea', label: 'Perfuração intestinal espontânea' },
    ],
  },
  {
    id: 'desafio-visual-149',
    category: 'Neonatologia',
    modality: 'Radiografia de tórax',
    difficulty: 'Intermediário',
    imageSrc: '/images/desafios/desafio-visual-149.webp',
  ...
  {
    id: 'desafio-visual-150',
    category: 'Neonatologia',
    modality: 'Radiografia de tórax',
    difficulty: 'Avançado',
    imageSrc: '/images/desafios/desafio-visual-150.webp',
    imageAlt: 'Radiografia de tórax com silhueta cardíaca ovalada e mediastino superior estreito',
    question: 'Recém-nascido com cianose intensa pouco responsiva ao oxigênio apresenta coração ovalado e mediastino superior estreito, no padrão “ovo sobre um fio”. Qual cardiopatia é mais provável?',
    options: [
      { id: 'transposicao-grandes-arterias', label: 'Transposição das grandes artérias' },
      { id: 'tetralogia-fallot', label: 'Tetralogia de Fallot' },
      { id: 'tronco-arterial-comum', label: 'Tronco arterial comum' },
      { id: 'retorno-venoso-pulmonar-anomalo', label: 'Retorno venoso pulmonar anômalo total' },
    ],
  },
];
