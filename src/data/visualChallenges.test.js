...
describe('visualChallenges', () => {
  it('mantém 120 desafios nativos completos após o oitavo lote', () => {
    expect(visualChallenges).toHaveLength(120);
    expect(new Set(visualChallenges.map(({ id }) => id)).size).toBe(120);
