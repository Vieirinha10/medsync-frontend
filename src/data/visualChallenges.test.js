...
describe('visualChallenges', () => {
  it('mantém 140 desafios nativos completos após o décimo lote', () => {
    expect(visualChallenges).toHaveLength(140);
    expect(new Set(visualChallenges.map(({ id }) => id)).size).toBe(140);
