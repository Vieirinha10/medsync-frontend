...
const AdminAcademicPage = () => {
  ...
  const saveCase = async (event) => {
    ...
    const payload = {
      titulo: caseForm.titulo, titulo_publico: caseForm.titulo_publico,
      especialidade: caseForm.especialidade,
