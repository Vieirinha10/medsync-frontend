...
const legalPages = {
  ...
  privacidade: {
    ...
    updatedAt: 'Última atualização: 2 de agosto de 2026',
    sections: [
      { title: '1. Dados que podemos tratar', items: ['Dados de cadastro, como nome, e-mail, período do curso, instituição de ensino e credenciais protegidas.', 'Dados de uso, como casos realizados, respostas, exames selecionados, notas e histórico de progresso.', 'Dados técnicos e de segurança, como registros de acesso, identificadores de requisição, dispositivo e informações necessárias à prevenção de abuso.', 'Dados de assinatura e pagamento, quando aplicável, processados com o apoio de prestadores especializados.'] },
      { title: '2. Para que utilizamos os dados', items: ['Criar, autenticar e proteger a conta do usuário.', 'Entregar simulações, avaliações, histórico e funcionalidades personalizadas.', 'Acompanhar desempenho e apresentar métricas educacionais.', 'Produzir análises agregadas sobre a comunidade acadêmica para orientar pesquisas, conteúdo, comunicação e ações institucionais do MedSync.', 'Melhorar estabilidade, segurança, conteúdo e experiência da plataforma.', 'Cumprir obrigações legais, regulatórias e exercer direitos em processos.'] },
